...
for DATA_NAME in cosine_diversity; do
    ...
    OUTPUT_PATH="/volume/pt-train/users/rbliu/checkpoint/leetcode/${MODEL_NAME}/${DATA_NAME}"
    mkdir -p $OUTPUT_PATH
    ...
    torchrun ${DISTRIBUTED_ARGS} finetune.py \
        ...
        --bf16 True \
        --seed 347 2>&1 | tee "${OUTPUT_PATH}/train.log"
    ...
    # bash /volume/pt-train/users/rbliu/github/OpenCodeEval/agent/leetcode_evaluate.sh $OUTPUT_PATH
    # sleep 3
