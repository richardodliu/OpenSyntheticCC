...
for DATA_NAME in budget_1 budget_2 budget_3 budget_4 budget_5 budget_6 budget_7 budget_8 budget_9 budget_10; do
    for LR in 1e-5; do
        ...
        OUTPUT_PATH="/volume/pt-train/users/rbliu/checkpoint/leetcode/budget-study/${DATA_NAME}"
        mkdir -p $OUTPUT_PATH
